...
/usr/lib/openmpi/mca_state_yarn.so
#----------------------------
...
/usr/lib64/openmpi/mca_state_yarn.so
...
#%post
#mkdir -p /%{_prefix}/lib63
#ln -s /%{_prefix}/lib/hamster_common.so  /%{_prefix}/lib63/libhamster_common.so
